...
; Завдання 2
(define (real-part z) (car z));перший елемент списку
(define (imagine-part z) (cdr z));другий елемент списку

(define (create-complex-value a b) (cons a b));пара
